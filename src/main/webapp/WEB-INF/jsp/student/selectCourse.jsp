				    ...
				    <table class="table table-bordered">
							...
							<c:forEach  items="${StudentCourseCustomList}" var="item">
									<tr>
										...
										<td>${item.progress}</td>
										<td>
											<button class="btn btn-default btn-xs btn-info" onClick="location.href='/student/startStudy?id=${item.courseId}'">学习</button>
											<button class="btn btn-default btn-xs btn-info" onClick="location.href='/student/startExam?id=${item.courseId}'">考试</button>
											<a class="btn btn-danger btn-xs" href="outCourse?id=${item.courseId}" onclick="return checkConfirm()">退课</a>
										</td>
									</tr>
							</c:forEach>
					        </tbody>
