			...
			<div class="col-md-10">
				<div class="panel panel-default">
				    ...
				    <div class="panel-body">
						<form name="reset" class="form-horizontal" role="form" action="/teacher/saveMark" id="editfrom" method="post" onsubmit="return check()">
							...
							<div class="form-group">
							  ...
							  <div class="form-group" style="text-align: center">
								  <button class="btn btn-default" onClick="location.href='/teacher/saveMark?courseId=${studentCourseCustom.courseId}&studentId=${studentCourseCustom.studentId} '">提交</button>
